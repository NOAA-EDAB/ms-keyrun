...
create_sim_survey_index_fw <- function(atlmod,fitstart=NULL,fitend=NULL,saveToData=T) {
  ...
  # read true list with run and biol pars, etc--specific to food web
  ...
  if (saveToData) {
    ...
    usethis::use_data(simSurveyIndexFW, overwrite = TRUE)
  }
  
  return(simSurveyIndexFW)
