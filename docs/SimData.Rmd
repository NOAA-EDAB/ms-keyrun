...
Species specific bin width definitions are an input into the model, with more refined (smaller) bin sizes during rapid growth phases. *Consider a function to do this using species max size and the desired number of bins for more consistency and to easily change Nsizebins.*
