...
* Aherring = Norwegian_ssh,
* Acod = North_atl_cod, 
* haddock = Haddock, 
* Amackerel = Mackerel. 

We will substitute bin widths from these GB species for NOBA:
* silverhake ~ Blue_whiting
* yellowtailfl ~ Long_rough_dab

NOBA Redfish
NOBA Saithe

NOBA Polar_cod and Capelin are smaller than any GB modeled species

NOBA Green_halibut are larger than any GB modeled species

These decisions will carry through to other life history parameters, at least initially.
