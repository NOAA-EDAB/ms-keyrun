...
We can get surface and bottom temp from atlatis using the layers from each polygon, with layer 0 (?) being the surface and the maximum layer in the polygon being the bottom. 
```{r}
