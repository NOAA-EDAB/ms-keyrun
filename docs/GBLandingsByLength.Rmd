...
process_hydra_GB_comland(channel,comlandData,lengthData)
```
...
For each species the annual landings (by NEGEAR) which are now apportioned to a population of fish lengths can be aggregated over the size class intervals described in table x (link).
