...
GB_strata <- sf::st_read(here::here("gis","Statistical_Areas_2010.shp"),quiet=T) %>%
    sf::st_transform(.,crs=crs) %>%
...
All gear types which catch any amount of the [Species](https://noaa-edab.github.io/ms-keyrun/SpeciesEnvDat.html#focalSpecies) of interest are used in the cluster analysis.
```{r echo=T,eval=F}
