...
```{r GBfoot, eval=T, fig.cap="Georges Bank EPU", fig.align='center'}
crs <- 4326
...
```{r calc_props_sp, eval=T, out.width="100%",fig.align='center',fig.cap="Proportion of landings in GB relative to statistical area"}
...
```{r calc_props_st, eval=T, out.width="100%",fig.align='center',fig.cap="Proportion of landings in GB relative to statistical area"}
...
```{r calc_lands,  eval=T, out.width="100%",fig.align='center',fig.cap="Total landings by statistical area"}
