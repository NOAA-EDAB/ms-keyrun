...
```{r calc_props_st, eval=T, out.width="100%",fig.align='center',fig.height=10,,fig.cap="Proportion of landings in GB relative to statistical area"}
...
```{r calc_lands,  eval=T, out.width="100%",fig.align='center',fig.height=10,fig.cap="Total landings by statistical area"}
