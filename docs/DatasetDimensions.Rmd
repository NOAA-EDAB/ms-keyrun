...
Define using fishery statistical areas and match survey data as much as possible to these. Easier to map survey strata to larger fishery areas than the other way around. 
...
knitr::kable(startend)
```

**Start year rationale:**
`r knitr::kable(responses$Rationale.for.start.time, col.names = NULL)`


**End year rationale:**
`r knitr::kable(responses$Rationale.for.end.time, col.names = NULL)`
...
**Survey season rationale:**
`r knitr::kable(responses$Rationale.for.survey.temporal.resolution, col.names = NULL)`


**Fishery season rationale:**
`r knitr::kable(responses$Rationale.for.fishery.temporal.resolution, col.names = NULL)`
...
**Spatial rationale:**
`r knitr::kable(responses$Rationale.for.spatial.definition, col.names = NULL)`
