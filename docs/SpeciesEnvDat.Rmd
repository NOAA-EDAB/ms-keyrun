...
These species received >1 vote for inclusion in MS-Keyrun multispecies models:
...
We can include GB temperature and primary production time series as part of the MS-Keyrun dataset. Modelers may retrieve additional data from `ecodata`.
...
All surveyed agreed that we should maintain datasets within an R data package for the MS-Keyrun project. 
