#' The Atlantis-simulated age class specific per capita consumption for the mskeyrun project
#'
#' Simulated per capita consumption data by age class from Atlantis model as sampled by atlantisom
#'
#' @format A data frame
#'
#' \describe{
