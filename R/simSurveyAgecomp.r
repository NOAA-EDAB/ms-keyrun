#' The Atlantis-simulated survey age composition for the mskeyrun project
#'
#' Simulated survey age composition data from Atlanits model as sampled by atlantisom
#'
#' @format A data frame
#'
#' \describe{
