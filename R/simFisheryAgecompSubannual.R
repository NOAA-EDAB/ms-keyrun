#' The Atlantis-simulated fishery age composition for the mskeyrun project
#'
#' Simulated fishery age composition data from Atlantis model as sampled by 
#' atlantisom. Temporal scale is Atlantis fishery output timestep.
#'
#' @format A data frame
#'
#' \describe{
