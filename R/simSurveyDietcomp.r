#' The Atlantis-simulated survey diet composition for the mskeyrun project
#'
#' Simulated survey diet composition data from Atlantis model as sampled by atlantisom
#'
#' @format A data frame
#'
#' \describe{
