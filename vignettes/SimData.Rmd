...
<details>
<summary>`NOBA2config.R` specifies location and names of files needed for atlantisom to initialize:</summary>
...
fwspp <- atlantisom::load_fgs(here("simulated-data/atlantisoutput/NOBA_sacc_38"), "nordic_groups_v04.csv") %>% 
