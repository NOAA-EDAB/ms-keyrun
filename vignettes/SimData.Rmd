...
A collection of functions used previously that may be harvested and modified for diagnostics or visualizations in the ms-keyrun and ICES WGSAM skill assessment projects. These functions assume you are using `atlantisom` output datasets but they could be generalized. 
...
source(here("data-raw/simulated-data/config/NOBA_sacc38Config.R"))

NOBAom_ms <- readRDS(file.path(d.name, paste0(scenario.name, "omlist_ss.rds")))

fitstartyr <- 40
fitendyr <- 120  #used 120 for sacc38
