...
coast <- sf::st_read(here::here("vignettes/gis", 'NES_LME_coast.shp'), quiet = T) %>%
  sf::st_transform(.,crs=crs)
GB_strata <- sf::st_read(here::here("vignettes/gis","Statistical_Areas_2010.shp"),quiet=T) %>%
    sf::st_transform(.,crs=crs) %>%
...
clusterObj <- cluster_by_focal_species(focalSpecies)
...
This exploratory study resulted in the following designation of [Fleets](https://noaa-edab.github.io/ms-keyrun/GBFleetDecisions.html)
